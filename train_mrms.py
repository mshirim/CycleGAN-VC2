        ...
        for epoch in range(self.start_epoch, self.num_epochs):
            ...
            if epoch % 2000 == 0 and epoch != 0:
                ...
                self.saveModelCheckPoint(epoch, '{}'.format(
                    self.modelCheckpoint + '_CycleGAN_CheckPoint_mrms'))
                print("Model Saved!")
...
if __name__ == '__main__':
    ...
    logf0s_normalization_default = place + '/cache_mrms/logf0s_normalization.npz'
    mcep_normalization_default = place + '/cache_mrms/mcep_normalization.npz'
    coded_sps_A_norm = place + '/cache_mrms/coded_sps_A_norm.pickle'
    coded_sps_B_norm = place + '/cache_mrms/coded_sps_B_norm.pickle'
    model_checkpoint = place + '/model_checkpoint/'
    resume_training_at = place + '/model_checkpoint/_CycleGAN_CheckPoint_mrms'
    #resume_training_at = None

    validation_A_dir_default = place + '/data/mrs_bennet/'
    output_A_dir_default = place + '/converted_sound/mrs_bennet'

    validation_B_dir_default = place + '/data/mr_bennet/'
    output_B_dir_default = place + '/converted_sound/mr_bennet/'
