        ...
        for epoch in range(self.start_epoch, self.num_epochs):
            ...
            if epoch % 2000 == 0 and epoch != 0:
                ...
                self.saveModelCheckPoint(epoch, '{}'.format(
                    self.modelCheckpoint + '_CycleGAN_CheckPoint_tellmrs'))
                print("Model Saved!")
...
if __name__ == '__main__':
    ...
    logf0s_normalization_default = place + '/cache_tellmrs/logf0s_normalization.npz'
    mcep_normalization_default = place + '/cache_tellmrs/mcep_normalization.npz'
    coded_sps_A_norm = place + '/cache_tellmrs/coded_sps_A_norm.pickle'
    coded_sps_B_norm = place + '/cache_tellmrs/coded_sps_B_norm.pickle'
    ...
    validation_A_dir_default = place + '/data/teller/'
    output_A_dir_default = place + '/converted_sound/teller'

    validation_B_dir_default = place + '/data/mrs_bennet/'
    output_B_dir_default = place + '/converted_sound/mrs_bennet/'
