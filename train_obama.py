        ...
        for epoch in range(self.start_epoch, self.num_epochs):
            ...
            if epoch % 2000 == 0 and epoch != 0:
                ...
                self.saveModelCheckPoint(epoch, '{}'.format(
                    self.modelCheckpoint + '_CycleGAN_CheckPoint_obama'))
                print("Model Saved!")
...
if __name__ == '__main__':
    ...
    logf0s_normalization_default = place + '/cache_obama/logf0s_normalization.npz'
    mcep_normalization_default = place + '/cache_obama/mcep_normalization.npz'
    coded_sps_A_norm = place + '/cache_obama/coded_sps_A_norm.pickle'
    coded_sps_B_norm = place + '/cache_obama/coded_sps_B_norm.pickle'
    ...
    validation_A_dir_default = place + '/data/obama_interview/'
    output_A_dir_default = place + '/converted_sound/obama_interview'

    validation_B_dir_default = place + '/data/obama_speech/'
    output_B_dir_default = place + '/converted_sound/obama_speech/'
