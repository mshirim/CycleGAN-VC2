        ...
        for epoch in range(self.start_epoch, self.num_epochs):
            ...
            if epoch % 2000 == 0 and epoch != 0:
                ...
                self.saveModelCheckPoint(epoch, '{}'.format(
                    self.modelCheckpoint + '_CycleGAN_CheckPoint_janemrs'))
                print("Model Saved!")
...
if __name__ == '__main__':
    ...
    logf0s_normalization_default = place + '/cache_janemrs/logf0s_normalization.npz'
    mcep_normalization_default = place + '/cache_janemrs/mcep_normalization.npz'
    coded_sps_A_norm = place + '/cache_janemrs/coded_sps_A_norm.pickle'
    coded_sps_B_norm = place + '/cache_janemrs/coded_sps_B_norm.pickle'
